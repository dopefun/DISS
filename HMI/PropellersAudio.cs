...
public class PropellersAudio : MonoBehaviour
{
    ...
    private void Awake()
    {
        ...
        // Assign AudioMixer
        AudioMixerGroup mixerGroupObject = audioMixer.FindMatchingGroups(mixerGroup)[0];
        m_EngineSoundSource.outputAudioMixerGroup = mixerGroupObject;
        m_WindSoundSource.outputAudioMixerGroup = mixerGroupObject;
